...
const char *Task2_name = "TASK2-TRATAMENTO DE DADOS\r\n"; //Comparação da temperatura atual com a real
const char *Task3_name = "TASK3-DEFINIÇÃO DE PERFIS\t\n"; //Comparação da Tag e os perfis de temperatura definidos
const char *Task4_name = "TASK4-CONTROLO DE VELOCIDADE\t\n"; //Atuação do motor conforme a divergencia da temperatura
...
void setup() {
	...
	my_porfiles[0] = { 605, (20, 22), 39200186180};	//White tag
	my_porfiles[1] = { 526, (22, 24), 12147227140};	//Blue tag
	my_porfiles[2] = { 151, (24, 26), 2365954};		//yellow tag
	...
	if (xQueue != NULL) {
		...
		xTaskCreatePinnedToCore(vTask2, "Data Processing Task", 1024,
				(void*) Task2_name, 3, &xTask2Handle, 1);
		xTaskCreatePinnedToCore(vTask3, "Porfile Selection Task", 1024,
				(void*) Task3_name, 1, NULL, 1);

		xTaskCreatePinnedToCore(vTask4, "Fan Speed Task", 1024,
